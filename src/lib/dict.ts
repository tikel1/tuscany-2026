...
export const DICT = {
  ...
  ticket_prev: { en: "Previous ticket", he: "כרטיס קודם" },
  ticket_next: { en: "Next ticket", he: "כרטיס הבא" },
  ticket_go_to: { en: "Go to ticket {n}", he: "מעבר לכרטיס {n}" },
