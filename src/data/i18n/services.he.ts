...
> = {
  ...
  "rest-s-il-barilotto": {
    name: "איל ברילוטו — סנטה פיורה",
    shortDescription: "המועדפת של סנטה פיורה, נוסתה ואושרה בטיול",
    description:
      "במארונטו ממש מחוץ לסנטה פיורה, בצד של מונטה אמיאטה. אחת משלוש המסעדות שבאמת אכלנו בהן ושהיינו חוזרים אליהן — משתלב יפה עם הפסקיירה והכפר.",
    address: "Via Carolina 24, מארונטו, סנטה פיורה (GR)"
  },
  "rest-s-novecento": {
    name: "נובצ׳נטו — סמפרוניאנו",
    shortDescription: "המקומית של הכפר, שש דקות מהאחוזה",
    description:
      "בסמפרוניאנו עצמה, הכפר הקרוב ביותר לקורטווקיה. ארוחת הערב הטובה הקרובה ביותר לווילה בפער גדול, וזה משנה באחוזה שהוזמנה חדר בלבד ואין בה מסעדה.",
    address: "Via Toscana 4, סמפרוניאנו (GR)"
  },
  "rest-s-lo-scangeo": {
    name: "לו סקנג׳או — סאטורניה",
    shortDescription: "נוסתה בטיול — על כביש SP10 ליד המעיינות",
    description:
      "למטה על ה־SP10 ליד הטרמה די סאטורניה ולא למעלה בכפר, ולכן היא משתלבת באופן טבעי עם בוקר בקסקטה דל מולינו.",
    address: "SP10, טרמה די סאטורניה, סאטורניה, מנצ׳אנו (GR)"
  },
  "rest-s-i-due-cippi": {
